...
//		payload.put("vmid",firewallDetails.getVmId());
		...
		String url = String.format("%s/nodes/%s/qemu/%s/firewall/rules", proxmoxApiUrl, firewallDetails.getNode(),vmId);
		...
		try {
			...
			if (response.getStatusCode() == HttpStatus.OK || response.getStatusCode() == HttpStatus.CREATED) {
				...
				return ResponseEntity.ok("Firewall rule created successfully: " + response.getBody());
			} else {
